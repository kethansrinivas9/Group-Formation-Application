...
final class AdminQueryConstants {
    ...
    public static final String GET_INSTRUCTOR_ID = "SELECT BannerID from CourseRole where CourseID = '%s' AND RoleID = '4'";
    public static final String GET_USERS_WHO_ARE_GUEST_OR_INSTRUCTOR = "SELECT BannerID FROM CourseRole WHERE RoleID = 4 UNION (SELECT BannerID FROM SystemRole WHERE RoleID=1 AND BannerID NOT IN (SELECT BannerID from CourseRole))";
    public static final String UPDATE_COURSE = "UPDATE Courses SET CourseName = '%s', CourseID = '%s' where CourseID = '%s'";
    public static final String UPDATE_INSTRUCTOR = "UPDATE CourseRole SET BannerID = '%s' where CourseID = '%s' AND RoleID = '4'";
